...
{
 ?>
     <form action="committee_event_criteria_edit.php?id=<?php echo $eid; ?>&criteria_ID=<?php echo $criteria_ID; ?>" method="post">
...
<div class="col-4 mt-5 text-start">
    <a href="committee_event_criteria.php?id=<?php echo $rows['id']; ?>&category_ID=<?php echo $rows["category_ID"] ?>" class="btn btn-danger">Cancel</a>
</div>
