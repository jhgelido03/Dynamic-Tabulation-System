...
<a href="admin_history.php?id=<?php  echo $id;     ?>" class="btn btn-primary back">Back</a>
</div>
...
<table id="example" class="table table-striped" style="width:90%;margin:auto">
        ...
        <form action="admin_event_category_view.php?id=<?php echo $row["id"]; ?>" method="post">
            ...
            <td><a href="admin_view_category_result.php?category_ID=<?php echo $row['category_ID']; ?>&id=<?php  echo $row["id"]  ?>" class="btn btn-primary">View Result</a></td>
            <?php
        $id = $row['id'];
