...
{
 ?>
     <form action="committee_event_category_edit.php?id=<?php echo $eid; ?>&category_ID=<?php echo $category_ID; ?>" method="post">
...
<div class="col-4 mt-5 text-start">
    <a href="committee_event_category_view.php?id=<?php echo $rows['id']; ?>" class="btn btn-danger">Cancel</a>
</div>
