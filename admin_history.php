...
$activePage = 'history';
$sql = "SELECT * from schedule_list where status = '2'";
...
<table id="example" class="table table-striped" style="width:90%;margin:auto;">
        ...
        <form action="admin_events.php" method="post">
            ...
            <td><a href="admin_result_category.php?id=<?php echo $row['id']    ?>" class="btn btn-info">Category Result</a>
                <a href="admin_view_results.php?id=<?php echo $row['id']    ?>" class="btn btn-primary">Overall Result</a></td>
            </form>
            <!-- <td></td> -->
