...
<table id="example" class="table table-striped" style="width:90%;margin:auto;">
        ...
        <form action="committee_events.php" method="post">
            ...
            <td><a href="committee_result_category.php?id=<?php echo $row['id']    ?>" class="btn btn-info">Category Result</a>
                <a href="committee_view_results.php?id=<?php echo $row['id']    ?>" class="btn btn-primary">Overall Result</a></td>
            </form>
            <!-- <td></td> -->
