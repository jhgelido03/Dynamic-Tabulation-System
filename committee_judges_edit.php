...
{
 ?>
     <form action="committee_judges_edit.php?id=<?php echo $eid  ?>&j_ID=<?php echo $j_ID;  ?>" method="post">
...
<div class="col-4 mt-5 text-start">
    <a href="committee_judges_view.php?id=<?php echo $rows['id']; ?>" class="btn btn-danger">Cancel</a>
</div>
