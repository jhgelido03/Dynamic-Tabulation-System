...
{
 ?>
     <form action="committee_candidates_view_edit.php?id=<?php echo $eid;?>&candidate_ID=<?php echo $cid; ?>" method="post" enctype="multipart/form-data">
...
{
  $event = "UPDATE candidates SET candidate_name='$cname', candidate_dept='$cdept',candidate_ys = '$cys', candidate_sex = '$csex', candidate_bday = '$cbday', candidate_contact = '$ccontact' where candidate_ID = '$cid' ";
