...
$sql = "SELECT * from  judges where j_username = '$cuname' AND id = $id";
$csql = mysqli_query($conn, $sql);
...
<a href="admin_judges.php" class="btn btn-primary back">Back</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="admin_judges_view.php?id=<?php echo $id  ?>" method="post">
<div class="col text-start">
<label for="jname" class="fw-bold">Judges Name</label>
            <input type="text" class="form-control " name="jname" required>
</div>
<div class="col text-start mt-2">
<label for="juname" class="fw-bold">Judges Username</label>
            <input type="text" class="form-control " name="juname" required>
</div>
<div class="col text-start mt-2">
<label for="jpass" class="fw-bold">Judges Password</label>
            <input type="password" class="form-control " name="jpass" required>
</div>
...
<table id="example" class="table table-striped" style="width:90%;margin:auto">
        ...
        ?>
        <tr>
        <form action="admin_judges_view.php?id=<?php echo $row["id"]  ?>" method="post">
            ...
            <td><a href="admin_judges_edit.php?j_ID=<?php echo $row['j_ID']; ?>&id=<?php echo $row["id"]; ?>" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></a>   
