...
$activePage = 'judges';
$eventid = $r["id"];
$sql = "SELECT * FROM schedule_list WHERE (status = '0' OR status = '1') AND id = '$eventid'";
...
<table id="example" class="table table-striped" style="width:90%;margin:auto;">
        ...
        ?>
        <tr>
        <form action="committee_judges.php" method="post">
            ...
            <td><a href="committee_judges_view.php?id=<?php echo $row['id']; ?>" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></svg></a></td>
            </form>
            <!-- <td></td> -->
            <!-- <td><a href="committeesidenavfixed-venue-confirmed-view.php?vr_ID=<?php echo $row['vr_ID'] ?>" class="btn btn-primary">View</a></td> -->
            <!-- <td>
                <form action="committeesidenavfixed-table-confirmed.php" method="post">
