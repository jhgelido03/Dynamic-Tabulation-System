...
<a href="committee_result_category.php?id=<?php   echo $id;    ?>" class="btn btn-primary back">Back</a>
</div>
    <div class="col-6 text-end p-3 ">
    <form action="admin_view_category_overall_report.php?id=<?php echo $id ?>&category_ID=<?php echo $categoryid;      ?>" method="post">
