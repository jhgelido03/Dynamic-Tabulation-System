...
<div class="col-md-8">
  ...
  <div class="col-10 text-start mt-2">
    <label for="inputEmail4" class="form-label">Candidate No.</label>
    <input type="number" class="form-control" id="inputEmail4" value="<?php  echo $rows["candidate_no"];     ?>">
  </div>
</div>
<div class="col-10 text-start mt-2">
...
<div class="col-4 mt-5 text-center">
    <a href="judges_tabulate_new.php?id=<?php echo $rows["id"]?>&category_ID=<?php echo $categoryid;  ?>" class="btn btn-danger">Close</a>
</div>
...
if($sql)
{
   ...
   document.querySelectorAll('button.swal2-confirm').forEach(a=>a.onclick=function(){window.parent.location='j_events.php'});
