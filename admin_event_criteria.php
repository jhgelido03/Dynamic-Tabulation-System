...
$sum = "SELECT SUM(criteria_percentage) AS total from criteria where category_ID = '$category_ID'";
...
if(mysqli_num_rows($sumsql)>0)
{
    ...
    {
        $sql = "SELECT * from criteria where criteria_name = '$cname' AND category_ID = '$category_ID'";
...
<a href="admin_event_category_view.php?category_ID=<?php echo $category_ID;?>&id=<?php echo $id  ?>" class="btn btn-primary back">Back</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="admin_event_criteria.php?category_ID=<?php echo $category_ID;?>&id=<?php echo $id  ?>" method="post">
...
<label for="cpass" class="fw-bold">Criteria Percentage</label>
            <input type="number" class="form-control " name="cpass" min="1" max="100" required>
</div>
...
<table id="example" class="table table-striped" style="width:90%;margin:auto">
        ...
        ?>
        <tr>
        <form action="admin_event_criteria.php?category_ID=<?php echo $row["category_ID"];?>&id=<?php echo $row["id"];?>" method="post">
