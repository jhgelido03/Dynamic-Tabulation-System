...
include("functions.php");
    ...
    $eventid = $_GET["id"];
    $sql = "SELECT * from  event_category where id = '$eventid'";
...
<a href="judges_history.php?id=<?php  echo $eventid;     ?>" class="btn btn-primary back">Back</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="j_event_category_view.php?id=<?php echo $id;?>" method="post">
...
<table id="example" class="table table-striped" style="width:90%;margin:auto">
        ...
        ?>
        <tr>
        <form action="j_event_category_view.php?id=<?php echo $row["id"]; ?>" method="post">
            ...
            <td><a href="judges_view_category_result.php?category_ID=<?php echo $row['category_ID']; ?>&id=<?php  echo $row["id"]  ?>" class="btn btn-primary">View Result</a></td>
            <?php
        $id = $row['id'];
